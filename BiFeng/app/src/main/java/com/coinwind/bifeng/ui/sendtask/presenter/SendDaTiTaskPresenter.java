 ...
 * 发送调研任务的P层
 */
public class SendDaTiTaskPresenter implements SendDaTiContract.Presenter {
    private SendDaTiContract.View view;
    private final SendTaskService service;

    public SendDaTiTaskPresenter() {
    ...
    public void sendTask(String share_score, String label, String type, String all_sharenum, String score, String all_tasknum,
                         ...
                         String publicImg, String url, String content, String taskType, List<SendDaTiBean> diaoYanBeans,String qualified, String startTime) {
        ...
        try {
            ...
            quesContent.put("passNum", qualified);
            quesContent.put("totalNum", diaoYanBeans.size());
            JSONArray ja = new JSONArray();
            for (SendDaTiBean daTiBean : diaoYanBeans) {
                JSONObject jo = new JSONObject();
                jo.put("title", daTiBean.getTitle());
                jo.put("num", daTiBean.getNum());
                jo.put("right",daTiBean.getRight());
                jo.put("A",daTiBean.getA());
                jo.put("B",daTiBean.getB());
                jo.put("C",daTiBean.getC());
                jo.put("D",daTiBean.getD());
    ...
    @Override
    public void actualView(SendDaTiContract.View view) {
        this.view = view;
    }
