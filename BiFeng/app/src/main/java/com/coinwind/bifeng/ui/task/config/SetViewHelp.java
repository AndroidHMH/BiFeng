...
//                return "拍照任务";
     ...
     * @param defaultImg
     */
    public static void setContent(String type, TextView firstTv, TextView secondTv, TextView thirdTv, TextView fourthTv, ImageView defaultImg) {
        switch (Integer.parseInt(type)) {
            case 1:
...
//                return "答题任务";
     ...
     * @param defaultImg
     */
    public static void setContent(String type, TextView firstTv, TextView secondTv, TextView thirdTv, ImageView defaultImg) {
        switch (Integer.parseInt(type)) {
            case 2:
